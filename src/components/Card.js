...
const Card = ({loadingData, showData, weather, forecast}) => {
    ...
    if(showData){
        ...
        forecastDate9 = forecast.list[4].dt_txt.substring(8, 10) + '/' + forecast.list[4].dt_txt.substring(5, 7) + '/' + forecast.list[4].dt_txt.substring(0, 4) + ' ' +  forecast.list[4].dt_txt.substring(11, 13);
    }
                        ...
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    <img src="https://images.pexels.com/photos/12890548/pexels-photo-12890548.jpeg?cs=srgb&dl=pexels-abdullah-al-sayem-12890548.jpg&fm=jpg" className="img-fluid rounded-start" alt="..."/>
                                </div>
                                <div className="col-md-8">
                                    ...
                                    <div className="row mt-4">
                                        <div className="col">
                                            <p>{forecastDate3}h</p>
                                            <p className="description"><img src={iconUrl3} alt="icon"/>{forecast.list[0].weather[0].description}</p>
                                        ...
                                        <div className="col">
                                            <p>{forecastDate9}h</p>
                                            <p className="description"><img src={iconUrl9} alt="icon"/>{forecast.list[4].weather[0].description}</p>
